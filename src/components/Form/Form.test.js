...
test('check if the form works', () => {
  const { getByLabelText, getByText, findByText, container } = render(<Form />)
  ...
  const mockUserResponse = {
    username: 'ayub3',
    followers_url: 'https://api.github.com/users/Ayub3/followers',
    interval: 500,
    avatar_url: 'https://avatars3.githubusercontent.com/u/50529930?s=460&v=4',
  }
  const mockFollowersResponse = [{ login: 'edificex' }, { login: 'redahaq' }]
  global.fetch = jest
    .fn()
